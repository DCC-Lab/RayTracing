...
examplesDir = "{0}/../examples".format(topDir)
exampleScriptNames = [f for f in os.listdir(examplesDir) if re.match(r'.*.py$', f)]
exampleScriptNames.sort()
exampleScripts = {name:"{0}/{1}".format(examplesDir, name) for name in exampleScriptNames}
