...
class LUMPlanFL40X(Objective):
    ...
    https://www.edmundoptics.com/p/olympus-lumplfln-40xw-objective/3901/
...
class XLUMPlanFLN20X(Objective):
    ...
    Model's specs can be found on :
    https://www.olympus-lifescience.com/en/objectives/xlumplfln-w/
    Immersion not considered at this point.
    """
    def __init__(self):
        super(XLUMPlanFLN20X, self).__init__(f=180/20, NA=1.0, focusToFocusLength=80, backAperture=22,
                                             workingDistance=2, label='XLUMPlanFLN20X',
...
class MVPlapo2XC(Objective):
    ...
    """
    def __init__(self):
        super(MVPlapo2XC, self).__init__(f=90/2, NA=0.5, focusToFocusLength=137, backAperture=45, workingDistance=20,
                                         label='MVPlapo2XC', url="")


class UMPLFN20XW(Objective):
    """ Olympus UMPLanFN 20XW immersion objective
    Model's specs can be found on :
    https://www.olympus-lifescience.com/en/objectives/lumplfln-w/#!cms[tab]=%2Fobjectives%2Flumplfln-w%2F20xw
    Immersion not considered at this point.
    """
    def __init__(self):
        super(UMPLFN20XW, self).__init__(f=180 / 20, NA=0.5, focusToFocusLength=45, backAperture=9, workingDistance=3.5,
                                         label='UMPLFN20XW',
...
class XLPLN25X(Objective):
    ...
    """
    def __init__(self):
        super(XLPLN25X, self).__init__(f=180/25, NA=1.05, focusToFocusLength=75, backAperture=18, workingDistance=2,
                                       label='XLPLN25X',
