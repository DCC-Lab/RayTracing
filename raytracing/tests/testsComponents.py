...
class Test4fSystem(unittest.TestCase):
    ...
    def test4fSystem(self):
        ...
        self.assertEqual(mg.A, system.A)
        self.assertEqual(mg.B, system.B)
        self.assertEqual(mg.C, system.C)
        self.assertEqual(mg.D, system.D)
        self.assertEqual(mg.L, system.L)
