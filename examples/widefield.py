...
path1.display(limitObjectToFieldOfView=True, onlyPrincipalAndAxialRays=True)
...
efficiency = 100*outputRays.count/inputRays.count
path2.display(limitObjectToFieldOfView=True, onlyPrincipalAndAxialRays=True)
...
efficiency = 100*outputRays.count/inputRays.count
path3.display(limitObjectToFieldOfView=True, onlyPrincipalAndAxialRays=True)
outputRays.display("Output profile {0:.0f}% efficiency".format(efficiency), showTheta=False)
