...
#illumination1.design['rayColors'] = ['b', 'b', 'b']
...
illumination2.fanAngle = 5
illumination2.objectPosition = 20
#illumination2.design['rayColors'] = ['g', 'g', 'g']
