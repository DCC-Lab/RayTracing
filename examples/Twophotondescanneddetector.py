...
path1 = ImagingPath()
path1.append(System4f(f1=50, diameter1=50, f2=50, diameter2=100))
path1.append(Aperture(diameter=5, label='Camera'))
...
path2.append(Aperture(diameter=5, label='Camera'))
